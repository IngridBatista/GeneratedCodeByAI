...
namespace DEEPSEEK.STRING_ARRAY_ENCODING.SENIOR.PARTICIPANT_1.Tests
{
    /// <summary>
    /// Testes da Questão 3 para DeepSeek - Participante 1 (MatrixString/MatrixException).
    /// Totalmente conforme: usa corretamente o construtor padrão em ambas as
    /// exceções. Extra: expõe Rows/Columns como propriedades públicas.
    /// </summary>

...
namespace CLAUDE.STRING_ARRAY_ENCODING.PLENO.PARTICIPANT_6.Tests
{
    /// <summary>
    /// Testes da Questão 3 para Claude - Participante 6, nível Pleno (MatrixString/MatrixException).
    /// Totalmente conforme: usa corretamente o construtor padrão em ambas as
    /// exceções, mesma qualidade dos Participantes 1 e 4 (Senior).
    /// </summary>

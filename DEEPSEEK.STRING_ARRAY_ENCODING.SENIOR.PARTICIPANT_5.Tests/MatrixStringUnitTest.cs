...
namespace DEEPSEEK.STRING_ARRAY_ENCODING.SENIOR.PARTICIPANT_5.Tests
{
    /// <summary>
    /// Testes da Questão 3 para DeepSeek - Participante 5 (MatrixString/MatrixException).
    /// Boa arquitetura (validação, inicialização e construção de string em
    /// métodos privados bem nomeados). MatrixException é usada corretamente
    /// com construtor padrão em Set() e RowToString(). ArgumentException usa
    /// mensagem customizada, divergindo da instrução.
    /// </summary>

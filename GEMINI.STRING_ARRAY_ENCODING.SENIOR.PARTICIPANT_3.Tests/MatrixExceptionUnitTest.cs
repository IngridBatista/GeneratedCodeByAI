...
namespace GEMINI.STRING_ARRAY_ENCODING.SENIOR.PARTICIPANT_3.Tests
{
    /// <summary>
    /// Testes da Questão 3 para Gemini - Participante 3 (MatrixString/MatrixException).
    ///
    /// ATENÇÃO - NÃO CONFORMIDADE GRAVE (mesmo padrão do GPT Participante 3):
    /// MatrixException possui APENAS o construtor MatrixException(string message).
    /// Não existe construtor padrão algum -- "new MatrixException()" nem
    /// compilaria contra esta classe.
    /// </summary>

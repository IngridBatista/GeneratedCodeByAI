...
namespace CLAUDE.STRING_ARRAY_ENCODING.SENIOR.PARTICIPANT_1.Tests
{
    /// <summary>
    /// Testes da Questão 3 para Claude - Participante 1 (MatrixString/MatrixException).
    /// Totalmente conforme: usa corretamente o construtor padrão em ambas as
    /// exceções, com comentário explícito confirmando o entendimento correto
    /// da instrução ("cria uma exceção genérica sem mensagem específica").
    /// </summary>

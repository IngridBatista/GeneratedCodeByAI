...
namespace GPT.STRING_ARRAY_ENCODING.PLENO.PARTICIPANT_6.Tests
{
    /// <summary>
    /// Testes da Questão 3 para GPT - Participante 6, nível Pleno (MatrixString/MatrixException).
    /// Implementação totalmente conforme, equivalente em corretude aos
    /// Participantes 1 e 4 (Senior) -- usa construtor padrão corretamente em
    /// ambas as exceções.
    /// </summary>

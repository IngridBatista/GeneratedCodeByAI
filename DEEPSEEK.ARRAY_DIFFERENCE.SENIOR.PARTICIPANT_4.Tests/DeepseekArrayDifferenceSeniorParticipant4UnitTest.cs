...
namespace DEEPSEEK.ARRAY_DIFFERENCE.SENIOR.PARTICIPANT_4.Tests
{
    /// <summary>
    /// Testes da Questão 1 para DeepSeek - Participante 4 (DeepseekArrayDifferenceSeniorParticipant4.Difference).
    /// Estruturalmente idêntico ao Participante 3: HashSet + foreach, nome conforme o enunciado.
    /// </summary>
    public class DeepseekArrayDifferenceSeniorParticipant4UnitTest
    {
        [Theory]
        ...
        {
            var resultado = DeepseekArrayDifferenceSeniorParticipant4.Difference(a, b);
        ...
        {
            var resultado = DeepseekArrayDifferenceSeniorParticipant4.Difference(
        ...
        {
            Action act = () => DeepseekArrayDifferenceSeniorParticipant4.Difference(null, new[] { 1, 5, 7 });
        ...
        {
            Action act = () => DeepseekArrayDifferenceSeniorParticipant4.Difference(new[] { 1, 5, 7 }, null);

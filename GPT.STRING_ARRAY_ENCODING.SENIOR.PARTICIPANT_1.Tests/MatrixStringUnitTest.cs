...
namespace GPT.STRING_ARRAY_ENCODING.SENIOR.PARTICIPANT_1.Tests
{
    /// <summary>
    /// Testes da Questão 3 para GPT - Participante 1 (MatrixString/MatrixException).
    /// Implementação direta e conforme o enunciado em todos os aspectos centrais.
    /// </summary>

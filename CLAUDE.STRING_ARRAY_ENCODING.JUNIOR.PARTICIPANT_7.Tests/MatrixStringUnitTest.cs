...
namespace CLAUDE.STRING_ARRAY_ENCODING.JUNIOR.PARTICIPANT_7.Tests
{
    /// <summary>
    /// Testes da Questão 3 para Claude - Participante 7, nível Junior (MatrixString/MatrixException).
    /// Totalmente conforme: usa corretamente o construtor padrão em ambas as
    /// exceções, mesma qualidade dos Participantes 1, 4, 5 e 6. Fecha o
    /// conjunto completo dos 4 LLMs para a Questão 3.
    /// </summary>

...
namespace GPT.ARRAY_DIFFERENCE.JUNIOR.PARTICIPANT_7.Tests
{
    /// <summary>
    /// Testes da Questão 1 para GPT - Participante 7 (ArrayUtils.Difference, nível Junior).
    ...
    ///
    /// Nome do método está conforme o enunciado ("Difference").
    /// </summary>
